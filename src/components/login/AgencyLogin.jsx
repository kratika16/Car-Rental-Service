...
const AgencyLogin = () => {
  ...
  return (
    <div>
      ...
      <h2 className='text-center font-weight-bold text-md mt-4 text-primary'>Agency Login here</h2>
      <form className=' w-25 h-50 p-4  bg-info border border-secondary rounded shadow mx-auto mt-5' onSubmit={handleSubmit}>
        ...
        <p className='text-center mt-1'>Don't have account? <span><Link to='/agencyRegister'>Register here</Link></span></p>
      </form>
    </div>
  )
}
