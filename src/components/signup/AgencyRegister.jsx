...
const AgencyRegister = () => {
  return (
    <div>
      ...
      <h2 className='text-center font-weight-bold text-md mt-4 text-primary'>New Agency Register here</h2>
      ...
      <div className='mb-3'>
        ...
        <p className='text-center mt-1'>Already have account? <span><Link to='/agencylogin'>Login here</Link></span></p>
      </form>
      </div>
  )
}
